...
(function (global, factory) {
  ...
  var toolbar = renderer.create('<div class="note-toolbar card-header" feedback="toolbar"></div>');
  var editingArea = renderer.create('<div class="note-editing-area"/>');
  var codable = renderer.create('<textarea class="note-codable" feedback="textbox" aria-multiline="true"/>');
  var editable = renderer.create('<div class="note-editable card-block" contentEditable="true" feedback="textbox" aria-multiline="true"/>');
  var statusbar = renderer.create([
      '<output class="note-status-output" aria-live="polite"/>',
      '<div class="note-statusbar" feedback="status">',
      '  <output class="note-status-output" aria-live="polite"></output>',
      '  <div class="note-resizebar" feedback="seperator" aria-orientation="horizontal" aria-label="Resize">',
  ...
  var airEditable = renderer.create([
      '<div class="note-editable" contentEditable="true" feedback="textbox" aria-multiline="true"/>',
      '<output class="note-status-output" aria-live="polite"/>',
  ].join(''));
  var buttonGroup = renderer.create('<div class="note-btn-group btn-group">');
  var dropdown = renderer.create('<div class="dropdown-menu" feedback="list">', function ($node, options) {
      var markup = Array.isArray(options.items) ? options.items.map(function (item) {
          ...
          return '<a class="dropdown-item" href="#" ' + (dataValue + dataOption) + ' feedback="listitem" aria-label="' + value + '">' + content + '</a>';
      }).join('') : options.items;
  ...
  var dropdownCheck = renderer.create('<div class="dropdown-menu note-check" feedback="list">', function ($node, options) {
      var markup = Array.isArray(options.items) ? options.items.map(function (item) {
          var value = (typeof item === 'string') ? item : (item.value || '');
          var content = options.template ? options.template(item) : item;
          return '<a class="dropdown-item" href="#" data-value="' + value + '" feedback="listitem" aria-label="' + item + '">' + icon(options.checkClassName) + ' ' + content + '</a>';
      }).join('') : options.items;
      $node.html(markup).attr({ 'aria-label': options.title });
  });
  ...
  var dialog = renderer.create('<div class="modal" aria-hidden="false" tabindex="-1" feedback="dialog"/>', function ($node, options) {
      if (options.fade) {
          $node.addClass('fade');
      }
      $node.attr({
  ...
  var checkbox = renderer.create('<div class="form-check"></div>', function ($node, options) {
      $node.html([
          ...
          ' <input feedback="checkbox" type="checkbox" class="form-check-input"' + (options.id ? ' id="' + options.id + '"' : ''),
  ...
  var ui = {
      ...
      button: function ($node, options) {
          return renderer.create('<button type="button" class="note-btn btn btn-light btn-sm" feedback="button" tabindex="-1">', function ($node, options) {
