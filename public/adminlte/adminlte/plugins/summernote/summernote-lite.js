...
(function (global, factory) {
  ...
  var toolbar = renderer.create('<div class="note-toolbar" feedback="toolbar"/>');
  var editingArea = renderer.create('<div class="note-editing-area"/>');
  var codable = renderer.create('<textarea class="note-codable" feedback="textbox" aria-multiline="true"/>');
  var editable = renderer.create('<div class="note-editable" contentEditable="true" feedback="textbox" aria-multiline="true"/>');
  var statusbar = renderer.create([
      '<output class="note-status-output" feedback="status" aria-live="polite"/>',
      '<div class="note-statusbar" feedback="resize">',
  ...
  var button = renderer.create('<button type="button" class="note-btn" feedback="button" tabindex="-1">', function ($node, options) {
      // set button type
  ...
  var dropdown = renderer.create('<div class="note-dropdown-menu" feedback="list">', function ($node, options) {
      var markup = Array.isArray(options.items) ? options.items.map(function (item) {
          var value = (typeof item === 'string') ? item : (item.value || '');
          var content = options.template ? options.template(item) : item;
          var $temp = $('<a class="note-dropdown-item" href="#" data-value="' + value + '" feedback="listitem" aria-label="' + value + '"></a>');
  ...
  var dropdownCheck = renderer.create('<div class="note-dropdown-menu note-check" feedback="list">', function ($node, options) {
      var markup = Array.isArray(options.items) ? options.items.map(function (item) {
          var value = (typeof item === 'string') ? item : (item.value || '');
          var content = options.template ? options.template(item) : item;
          var $temp = $('<a class="note-dropdown-item" href="#" data-value="' + value + '" feedback="listitem" aria-label="' + item + '"></a>');
  ...
  var dialog = renderer.create('<div class="note-modal" aria-hidden="false" tabindex="-1" feedback="dialog"/>', function ($node, options) {
      if (options.fade) {
          $node.addClass('fade');
      }
      $node.attr({
  ...
  var checkbox = renderer.create('<div class="checkbox"></div>', function ($node, options) {
      $node.html([
          ...
          ' <input feedback="checkbox" type="checkbox"' + (options.id ? ' id="' + options.id + '"' : ''),
